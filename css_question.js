...
function updateTable() {
	...
	table.innerHTML = '<tr style="background: purple; font-weight: bold; color: white;"><td>STT</td><td><p>Câu hỏi</p></td><td>Loại câu hỏi</td><td>Người thêm</td><td>Thời gian thêm</td><td>Trạng thái</td><td>Chỉnh sửa</td><td>Xóa</td><td>Xem chi tiết</td><td>#</td></tr>';
	...
	for (let i = 0; i < listQscss.length; i++) {
            ...
            cell10.innerHTML = qsindex.comment;
            console.log(qsindex.comment);
            ...
            function editQuestion(index) {
    			...
    			if(listQscss[index].status=="Chờ duyệt" || listQscss[index].status=="Không duyệt"){
